...
(** [lemma_isa_cstor (d …) (is-c t)] returns the clause [(c …) = t |- is-c t] or
    [(d …) = t |- ¬ (is-c t)] *)

val lemma_select_cstor : cstor_t:Term.t -> Term.t -> Proof.Pterm.t
(** [lemma_select_cstor (c t1…tn) (sel-c-i t)] returns a proof of
    [t = c t1…tn |- (sel-c-i t) = ti] *)
...
(** [lemma_isa_disj (is-c t) (is-d t)] is the proof of
    [¬ (is-c t) \/ ¬ (is-c t)] *)
...
(** [lemma_isa_distinct (c …) (d …)] is the proof of the unit clause
    [|- (c …) ≠ (d …)] *)

val lemma_acyclicity : (Term.t * Term.t) list -> Proof.Pterm.t
(** [lemma_acyclicity pairs] is a proof of [t1=u1, …, tn=un |- false] by
    acyclicity. *)
